...
function AppSidebar() {
  const { resetTableState } = useContext(TableContext);

  return (
    <>
      <Sidebar className="mt-16 pt-4" side="left" variant="sidebar" collapsible="icon">
        <SidebarContent>
          <SidebarGroup>
            <SidebarGroupContent>
              <SidebarMenu>
                            ...
                            return (
                              <SidebarMenuSubItem key={index}>
                                <SidebarMenuSubButton
                                  ...
                                  asChild
                                >
                                  <Link onClick={resetTableState} to={link.url}>
